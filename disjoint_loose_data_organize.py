...
root_dir = 'Megaface_Challenge_1M_disjoint_LOOSE'
#json_dir = 'MegafaceIdentities_VGG_META'
created_files_dir = '/workspace/data/__face_datasets__/MegaFace/disjoint_loose_created_files/'
output_jsonlist = 'disjoint_loose_json_list.json'
...
def get_bbox_info(cropped_box,exp_box):
	...
	right = exp_box['right'] - cropped_box['right']
	top = cropped_box['top'] - exp_box['top']
	bottom = exp_box['bottom'] - cropped_box['bottom']
	face_pts = []
